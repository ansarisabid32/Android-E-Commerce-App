...
public class categoryProductsModel {
    ...
    public categoryProductsModel(String productImage, String productTitle, String freeCoupons, String rating, String totalRatings, String productPrice, String cuttedProductPrice, boolean COD) {
