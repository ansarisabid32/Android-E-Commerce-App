...
public class ProductSpecificationAdapter extends RecyclerView.Adapter<ProductSpecificationAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ProductSpecificationAdapter.ViewHolder holder, int position) {
        switch (productSpecificationModelList.get(position).getType()){
            case ProductSpecificationModel.SPECIFICATION_TITLE:
                ...
                break;
            case ProductSpecificationModel.SPECIFICATION_BODY:
                String featureN = productSpecificationModelList.get(position).getFeature_name();
                String featureV = productSpecificationModelList.get(position).getFeature_value();
                holder.setFeature(featureN, featureV);
                break;
            default:
                return;
        }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private void setTitle(String t){
            title=(TextView) itemView; title.setText(t);
        }
        private void setFeature(String featureN, String featureV) {
            featureName = (TextView) itemView.findViewById(R.id.productSpecificationItem_featureName);
            featureValue = (TextView) itemView.findViewById(R.id.productSpecificationItem_featureValue);
